...
description: Grow repeat business from the dashboard -- audience, bonus sessions, campaigns, content, Frame Lab, microsite branding, and performance.
tags: [dashboard, marketing, bonus, frame-lab, microsite]
---

# Marketing Studio

**Marketing Studio** groups the tools that turn photo sessions into repeat customers.

## Audience

The contacts you have captured at the booth, for example through the bonus session prompt. Export them or use them in campaigns.
...
Plan promotions and keep the copy and creative you use across your booths and social channels in one place.
...
Brand the pages customers land on when they scan the QR code on the sharing screen: logo, colours, and the links you want shown next to their photos.
