...
description: A practical checklist for launching a new kiosk location and keeping it running smoothly.
tags: [guides, checklist, operations]
---

# Booth Operations Checklist

Running a smooth kiosk location comes down to a solid launch and steady upkeep. Use this checklist when you set up a new location, and again on a regular schedule to keep it running without surprises.

## Before Launching a New Location
...
- [ ] Connect to the location's Wi-Fi or your mobile hotspot
- [ ] Confirm the desktop app shows "Online" status
- [ ] Test that QR sharing works by scanning with your phone
...
:::caution
Never power off the laptop while there are pending uploads. Let the offline queue drain first.
:::
...
:::info
All photos are automatically uploaded to your cloud storage. You don't need to manually transfer files from the laptop unless you want a local backup.
:::
