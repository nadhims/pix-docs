...
![The Pixture dashboard home page with the Revenue, Sessions, Session Completion, Peak Day, Prints, Vouchers and Templates Usage cards](/img/docs/dashboard-home.webp)

## Start Here

Five steps take a new account to its first photo session. Most operators finish in about fifteen minutes.
...
3. [Install the Pix Desktop App](./getting-started/download-desktop-app.md) on the booth computer.
