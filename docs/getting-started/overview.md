...
2. **[Claim your free 3-day trial](./choose-plan.md)** -- Every organization can claim one free 3-day **Pix Pro** trial on one computer, from the trial card in the dashboard (the popup, or the bell menu) or from the kiosk's operator menu. It goes on the computer paired to the booth you pick. Until a pass or Pix Pro is active on a computer, its photos and prints carry the Pixture watermark.
