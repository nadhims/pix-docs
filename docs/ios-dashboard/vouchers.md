...
Vouchers let you offer discount codes to guests. Use them for promotions, event-specific pricing, or loyalty rewards. You can control how many times a code can be used and when it expires.
...
3. Fill in the details:
   - **Code** — the text guests enter (e.g., "WEDDING50", "FREEPHOTO"). Codes are case-insensitive.
...
:::tip
For event-specific vouchers, set the expiry date to the day after the event. This way the code works during the event but can't be reused later.
:::
...
- Review the redemption history after events to measure promotion effectiveness.
