...
- **Sharing status** — whether the customer downloaded, emailed, or printed the photo
...
Use the search bar to find photo sessions by customer name or email (if sharing data was captured). This is helpful when a customer contacts you later asking for their photos.
