...
sidebar_position: 7
title: Sharing
description: How guests receive their photos via QR code, print, and microsite in the Pix Desktop App.
...
A QR code is displayed on screen that guests scan with their phone. This links to their branded microsite, where they can view, download, and share their photos.
...
### Microsite (Guest Page)

Every session's photos are uploaded to a branded microsite at a unique URL. This mobile-friendly page displays your organization's logo and name, and allows guests to:
